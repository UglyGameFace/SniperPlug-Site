...
const syntax = spawnSync(process.execPath, ['--check', join(root, 'functions/_lib/posts.js')], { encoding: 'utf8' });
assert.equal(syntax.status, 0, `functions/_lib/posts.js has invalid JavaScript syntax:\n${syntax.stderr}`);
